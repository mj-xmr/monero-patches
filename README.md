...
# CI
There exists a CI script (`ci.sh`) in the main directory, which tests and lists all the available patches. 
...
- `testnet-scripts.patch`: An elegant update to the testnet scripts, that fixes a few crashes.
